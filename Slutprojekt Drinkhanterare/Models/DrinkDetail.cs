...
{
    //DrinkDetailObject, wrapper för API-svar med drink-detaljer
    public class DrinkDetailObject
    {
        //wrapper-klass för deserialisering av detaljerat drink-svar från API
        [JsonProperty("drinks")]
        public List<DrinkDetail> DrinkDetailList { get; set; }
    }

    //DrinkDetail, modell för drinkens detaljerade information från API
